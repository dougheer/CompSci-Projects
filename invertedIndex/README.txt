...
The code itself is comprised of 4 classes a main method, a documnet class, a postings class and the invertedIndex class.

To run it you put all the classes into a java compiler.
Then all you need to do is modify and use the methods provides to run basic quires on the invrted list created when the prgram is run.
